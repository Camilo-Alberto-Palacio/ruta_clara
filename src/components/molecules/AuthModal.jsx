                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        {onOpenFavorites && (
                            <button
                                ...
                                className="w-full py-3 px-4 rounded-2xl bg-emerald-50 hover:bg-emerald-100 text-emerald-800 font-extrabold text-sm flex items-center justify-center gap-2 transition-all cursor-pointer border border-emerald-200 active:scale-98 shadow-2xs mb-3"
                            >
                        ...
                        {/* Si está en modo Invitado, permitir conectar con Google */}
                        {currentUser.isGuest && (
                            <button
                                onClick={handleGoogleLogin}
                                disabled={isLoading}
                                className="w-full py-3 px-4 rounded-2xl bg-white hover:bg-slate-50 text-slate-700 font-extrabold text-sm flex items-center justify-center gap-2.5 transition-all cursor-pointer border border-slate-300 shadow-xs active:scale-98 mb-3"
                            >
                                ...
                                <span>{isLoading ? 'Conectando...' : 'Vincular Cuenta de Google'}</span>
                            </button>
                        )}
