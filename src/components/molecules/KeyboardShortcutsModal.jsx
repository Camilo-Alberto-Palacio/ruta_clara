    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-emerald-950/30 backdrop-blur-sm animate-fade-in">
            <div className="bg-white rounded-3xl shadow-2xl border border-emerald-100 w-full max-w-md overflow-hidden animate-scale-up text-slate-800 flex flex-col">
                ...
                <div className="p-5 bg-gradient-to-r from-emerald-600 via-emerald-700 to-green-800 text-white flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[11px] text-emerald-100">Navega como un experto en escritorio</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="p-5 flex flex-col gap-3">
                    <div className="flex flex-col gap-2">
                        {SHORTCUTS.map((item, idx) => (
                            ...
                            >
                                ...
                                <kbd className="px-2.5 py-1 rounded-lg bg-white text-emerald-800 border border-emerald-200 font-mono font-bold text-2xs shadow-xs ml-2 flex-shrink-0">
                                    {item.key}
                                </kbd>
                            </div>
                        ))}
                    ...
                    <div className="pt-2 flex justify-end">
                        <button
                            onClick={onClose}
                            className="px-5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs border-none cursor-pointer shadow-xs transition-colors"
                        >
                            Entendido
                        </button>
                    </div>
